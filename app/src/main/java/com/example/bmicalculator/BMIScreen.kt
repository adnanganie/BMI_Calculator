...
fun BMIScreen(
    ...
    ModalBottomSheetLayout(sheetState = modalBottomSheet,
        sheetContent = {
            BottomSheetContent(sheetTitle = state.sheetTitle,
        ...
        content = {
            BMIScreenContent(state = state, onWeightUnitClicked = {
        ...
        Column(
            ...
            Row(
                ...
                InputUnitValue(
                    ...
                    inputNoColor = if (state.weightValueStage != WeightValueStage.INACTIVE) {
                        CustomOrange
                    } else Color.Black,
                ...
                if (it) {
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            SymbolButton(symbol = "C", onClick = onACButtonClicked)
